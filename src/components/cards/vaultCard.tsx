...
function Vault(valor: any){
    switch(valor){
        case ShopCardsTypes.shop:
            
            return(<img src = {require("../../images/cards_images/VAULT.PNG")} style={{padding:'0px'}}/>)
        ...
        case ShopCardsTypes.active:
           ...
           return(<img src = {require("../../images/cards_images/VAULT.PNG")} style={{width:'50px',height:'100px', padding: '0px'}}/>)
